---
title: "243. HarnessX：第 11 课：让 Agent 识别三类模型故障，用重试、压缩和续写恢复执行"
---
...
![243. HarnessX：第 11 课：让 Agent 识别三类模型故障，用重试、压缩和续写恢复执行 图表 1](/assets/os/mermaid-1e4294f45dbb89fc6862e585f333c4d0370481c7e8653f02a45ae747649c0284.svg)
...
![243. HarnessX：第 11 课：让 Agent 识别三类模型故障，用重试、压缩和续写恢复执行 图表 2](/assets/os/mermaid-373430cb11c49455c9dd8a52301fd4555dd20462f5aeacf9dfc18a2b121174cb.svg)

## 这一层放在系统哪里

第 11 课的改动位置很关键。错误恢复不能散落在工具里，也不应该让每个业务分支自己判断。

![243. HarnessX：第 11 课：让 Agent 识别三类模型故障，用重试、压缩和续写恢复执行 图表 3](/assets/os/mermaid-7c42478a38a7ddc2538c4a940fca80f9b89d4b42446f6094f177d98c61c93514.svg)
...
![243. HarnessX：第 11 课：让 Agent 识别三类模型故障，用重试、压缩和续写恢复执行 图表 4](/assets/os/mermaid-4dfc823a97c3af93584afe08398b50c479fe0f0b237d8d4ba85fb7ad8b6fdce1.svg)

## 三条恢复路径

如果只看恢复决策，第 11 课可以压成这张图。这里不画回到请求模型的回边，把“重新请求”写进动作节点里，避免线条交叉。

![243. HarnessX：第 11 课：让 Agent 识别三类模型故障，用重试、压缩和续写恢复执行 图表 5](/assets/os/mermaid-d32f0afdf7ea34138f6fad0b724a037853549db593fbb36bffb7978eee6633b8.svg)
...
![243. HarnessX：第 11 课：让 Agent 识别三类模型故障，用重试、压缩和续写恢复执行 图表 6](/assets/os/mermaid-83b62bd43d52c901751737b5948b43134b37c39de2bdb958cd24392e556c3fcd.svg)
...
![243. HarnessX：第 11 课：让 Agent 识别三类模型故障，用重试、压缩和续写恢复执行 图表 7](/assets/os/mermaid-2c621a73f9901730398b0b263d6b01add6cd734e66ca4deaae9b2a20beed6ab6.svg)
