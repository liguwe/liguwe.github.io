---
title: "221. HarnessX：第 3 课：在工具真正执行前加权限门，让 Agent 先判断 allow、ask、deny"
---
...
![221. HarnessX：第 3 课：在工具真正执行前加权限门，让 Agent 先判断 allow、ask、deny 图表 1](/assets/os/mermaid-ef592ec860e3b36bbf9fc998d4d4463d4a36464eedfd5eff3355ce4dd5cf4e02.svg)
...
![221. HarnessX：第 3 课：在工具真正执行前加权限门，让 Agent 先判断 allow、ask、deny 图表 2](/assets/os/mermaid-b9abd88975b831e0217d89385ed44e07c5f3fa2245cdaeb3af8f27995bcbf0d8.svg)

### 2.3. 权限门细分：allow、ask、deny

![221. HarnessX：第 3 课：在工具真正执行前加权限门，让 Agent 先判断 allow、ask、deny 图表 3](/assets/os/mermaid-1db22fb1b2322fc5824e9a9a80e8e6d6279b893ff69915c7a0c7f36b5c30e586.svg)

### 2.4. messages 怎么继续变长

![221. HarnessX：第 3 课：在工具真正执行前加权限门，让 Agent 先判断 allow、ask、deny 图表 4](/assets/os/mermaid-def5aae976359baef9b5d1b2359d3701e934d4fc8f7484c27ef1f429a498b2dc.svg)
...
async function runToolCall(toolCall) {
  ...
  return TOOL_HANDLERS【内部：toolName】;
}
```
