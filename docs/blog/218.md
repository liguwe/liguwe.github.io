---
title: "218. HarnessX：第 1 课：Agent 循环，本质就是一个会反复调用模型、执行工具、回传结果的 while 循环"
---
...
![218. HarnessX：第 1 课：Agent 循环，本质就是一个会反复调用模型、执行工具、回传结果的 while 循环 图表 1](/assets/os/mermaid-0e72fbda88283b6657bccc3a0f7eb20b3501e53855c3ba13d0dad6fa05be5ea0.svg)

### 2.2. Agent Loop

![218. HarnessX：第 1 课：Agent 循环，本质就是一个会反复调用模型、执行工具、回传结果的 while 循环 图表 2](/assets/os/mermaid-ebc7c754c1c332c4f4db75af9fbd48da949d1637f3e44715b38e1dc852040deb.svg)

### 2.3. messages 怎么变长

![218. HarnessX：第 1 课：Agent 循环，本质就是一个会反复调用模型、执行工具、回传结果的 while 循环 图表 3](/assets/os/mermaid-071a44878d01ad7f36423848294b30560ce6a359f74f5032e2235bec42dc1dcc.svg)
...
第 0 课已经有 `hello`、`ask`、`chat`。详见 [HarnessX：第 0 课：先让 hx 命令跑起来、Agent 的第一性原理](/blog/214)
