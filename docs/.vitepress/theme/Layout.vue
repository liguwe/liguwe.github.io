...
const postHeroTitle = computed(
    () => currentPost.value?.title ?? page.value.title ?? "",
);
...
function openLocalSearch() {
    ...
    nextTick(() => {
        document
            .querySelector("#local-search .DocSearch-Button")
            ?.dispatchEvent(
...
<template>
    <div
        class="site-root relative min-h-screen w-screen overflow-x-clip bg-cream-100/20 text-offgray-800 dark:bg-[hsl(218,13%,7.5%)] dark:text-offgray-300"
    >
        <div
            class="nav-background absolute top-0 left-0 z-[-1] h-full w-4 sm:w-6 md:w-12"
            aria-hidden="true"
        />
        <div
            class="nav-background absolute top-0 right-0 z-[-1] h-full w-4 sm:w-6 md:w-12"
            aria-hidden="true"
        />
        ...
        <div class="relative flex flex-1 flex-col overflow-x-clip">
            <div
                ...
                :class="
                    menuOpen
                        ? 'scale-[0.98] translate-y-1 overflow-hidden rounded-t-lg'
                        : ''
                "
            >
                <header
                ...
                >
                    ...
                    />
                    <span
                        class="relative z-[1] w-4 shrink-0 border-r border-[var(--border)] sm:w-6 md:w-12 lg:border-r-0"
                        aria-hidden="true"
                    >
                    </span>
                    <span
                        class="relative z-[1] hidden flex-1 border-x border-[var(--border)] lg:block"
                        aria-hidden="true"
                    />
                    ...
                    >
                        ...
                        <ul
                            class="ml-auto hidden list-none items-center gap-1.5 lg:m-0 lg:flex"
                            aria-orientation="horizontal"
                        >
                            <li
                                class="vp-nav-local-search flex items-center relative"
                            >
                                <button
                                    type="button"
                            ...
                            <li
                                class="h-5 w-px border-l border-[var(--border)]"
                                aria-hidden="true"
                            />
                            <li>
                                <button
                            ...
                            <li class="group/more relative">
                                ...
                                >
                                    ...
                                    >
                                        ...
                                        >
                                            <img
                                                :src="withBase('/yuque.svg')"
                                                class="size-[18px] shrink-0 opacity-70 dark:invert"
                                                aria-hidden="true"
                                            />
                                            <span class="min-w-0 flex-1"
                                                >语雀</span
                    ...
                    />
                    <span
                        class="relative z-[1] w-4 shrink-0 border-l border-[var(--border)] sm:w-6 md:w-12 lg:border-l-0"
                        aria-hidden="true"
                    />
                </header>
                ...
                <main v-if="isBlogIndex" class="flex min-h-0 flex-1 flex-col">
                    ...
                    >
                        ...
                        >
                            <svg
                                class="pointer-events-none absolute inset-0 text-accent-blue/15 dark:text-blue-300/5"
                                width="100%"
                                height="100%"
                            ...
                            >
                                ...
                                >
                                    ...
                                    >
                                        <path
                                            d="M0 0V-1H-1V0H0ZM0 0V1H24V0V-1H0V0ZM0 24H1V0H0H-1V24H0Z"
                                            fill="currentColor"
                                        />
                                    </svg>
                                </pattern>
                            ...
                            <div
                                class="default-border-text-color pointer-events-none absolute top-0 bottom-0 right-[-0.5px] w-[10px] translate-x-1/2"
                            >
                                <div
                                    class="absolute top-0 bottom-0 left-1/2 flex w-px -translate-x-1/2 flex-col"
                                >
                                    <div
                                        class="w-px flex-[1.067747235329704] bg-current"
                                    />
                                    <div
                                        class="w-px flex-[4.561247827280894] bg-current"
                                    />
                                </div>
                            </div>
                        </span>
                        ...
                        >
                            ...
                            >
                                ...
                                >
                                    <div
                                        class="w-px flex-[2.810797334560564] bg-current"
                                    />
                                    <div
                                        class="w-px flex-[4.996210100127482] bg-current"
                                    />
                                </div>
                            </div>
                        </span>
                        <div
                            class="relative z-[2] container-max-w max-md:min-w-0 flex-1 [--node-horizontal-offset:-3.5px]"
                        >
                            <div
                        ...
                        >
                            <div
                                class="default-border-text-color pointer-events-none absolute top-0 bottom-0 left-[-0.5px] w-[10px] -translate-x-1/2"
                            >
                                <div
                                    class="absolute top-0 bottom-0 left-1/2 flex w-px -translate-x-1/2 flex-col"
                                >
                                    <div
                                        class="w-px flex-[3.8821601881096885] bg-current"
                                    />
                                    <div
                                        class="w-px flex-[1.869571805405231] bg-current"
                                    />
                                    <div
                                        class="w-px flex-[1.0783224106199678] bg-current"
                                    />
                                    <div
                                        class="w-px flex-[1.4467267992192538] bg-current"
                                    />
                                    <div
                                        class="w-px flex-[4.047455312240615] bg-current"
                                    />
                                </div>
                            </div>
                        </span>
                        ...
                        >
                            ...
                            >
                                ...
                                >
                                    <div
                                        class="w-px flex-[3.3796901713962155] bg-current"
                                    />
                                    <div
                                        class="w-px flex-[3.982290269333073] bg-current"
                                    />
                                    <div
                                        class="w-px flex-[4.161550523322798] bg-current"
                                    />
                                    <div
                                        class="w-px flex-[2.140127182537749] bg-current"
                                    />
                                </div>
                            </div>
                        </span>
                    ...
                    >
                        <svg
                            class="pointer-events-none absolute inset-0 z-0 size-full select-none py-[1px] text-offgray-200/70 !opacity-30 dark:text-blue-400/10 dark:!opacity-60"
                            xmlns="http://www.w3.org/2000/svg"
                        >
                            <defs>
                                <pattern
                                    id="zed-divider-slash"
                                    width="4"
                                    height="4"
                                    patternUnits="userSpaceOnUse"
                            ...
                            <rect
                                width="100%"
                                height="100%"
                                fill="url(#zed-divider-slash)"
                            />
                        </svg>
                    </section>

                    <section
                        class="outer-section-node-offset relative z-[1] flex min-h-[calc(100vh-240px)] min-w-0 flex-1 items-stretch"
                    >
                        <div
                            class="pointer-events-none absolute z-[110] size-1.5 rotate-45 border border-offgray-100 bg-[var(--node-bg)] dark:border-offgray-900 dark:bg-[hsl(219,92%,2%)] [top:calc(-1*var(--node-vertical-offset))] [left:var(--node-horizontal-offset)]"
                            aria-hidden="true"
                        ...
                        />
                        <span
                            class="relative z-[1] w-4 shrink-0 self-stretch border-r border-[var(--border)] sm:w-6 md:w-12 lg:border-r-0"
                            aria-hidden="true"
                        >
                            <div
                                class="default-border-text-color pointer-events-none absolute top-0 bottom-0 right-[-0.5px] w-[10px] translate-x-1/2"
                            >
                                ...
                                >
                                    <div
                                        class="w-px flex-[2.8083788164930317] bg-current"
                                    />
                                    <div
                                        class="w-px flex-[4.3946094528746835] bg-current"
                                    />
                                </div>
                            </div>
                        </span>
                        <span
                            class="relative z-[1] hidden flex-1 self-stretch border-x border-[var(--border)] lg:block"
                            aria-hidden="true"
                        >
                            <div
                                class="default-border-text-color pointer-events-none absolute top-0 bottom-0 right-[-0.5px] w-[10px] translate-x-1/2"
                            >
                                ...
                                >
                                    <div
                                        class="w-px flex-[2.81904649819203] bg-current"
                                    />
                                    <div
                                        class="w-px flex-[2.6110425002924362] bg-current"
                                    />
                                    <div
                                        class="w-px flex-[4.921013357080991] bg-current"
                                    />
                                </div>
                            </div>
                        </span>
                        <div
                            class="relative z-[2] container-max-w flex max-md:min-w-0 min-h-[75vh] flex-1 flex-col [--node-horizontal-offset:-3.5px]"
                        >
                            <div
                                class="pointer-events-none absolute z-[110] size-1.5 rotate-45 border border-offgray-100 bg-[var(--node-bg)] dark:border-offgray-900 dark:bg-[hsl(219,92%,2%)] [top:calc(-1*var(--node-vertical-offset))] [left:var(--node-horizontal-offset)] hidden lg:block"
                                aria-hidden="true"
                            ...
                            />
                            <div
                                class="isolate relative flex min-h-0 flex-1 flex-col p-0"
                            >
                                <div
                                    class="relative grid min-h-0 w-full flex-1 grid-cols-5"
                                >
                                    <div
                                    ...
                                    <div
                                        class="col-span-5 flex min-h-0 flex-col lg:col-span-4"
                                    >
                                        <div
                                            class="border-l border-dashed default-border-color relative flex min-h-0 flex-1 flex-col p-4 lg:p-8"
                                        >
                                            <div
                                                class="pointer-events-none absolute z-[110] size-1.5 rotate-45 border border-offgray-100 bg-[var(--node-bg)] dark:border-offgray-900 dark:bg-[hsl(219,92%,2%)] [top:calc(-1*var(--node-vertical-offset))] [left:var(--node-horizontal-offset)] hidden lg:block"
                                                aria-hidden="true"
                                            ...
                                            >
                                                ...
                                                >
                                                    ...
                                                    <span
                                                        ...
                                                        class="hidden opacity-15 lg:flex dark:opacity-[0.08]"
                                                        aria-hidden="true"
                                                        >|</span
                                                    >
                                                    <p
                        ...
                        >
                            ...
                            >
                                ...
                                >
                                    <div
                                        class="w-px flex-[2.9101247796370298] bg-current"
                                    />
                                    <div
                                        class="w-px flex-[1.6569280627448708] bg-current"
                                    />
                                </div>
                            </div>
                        </span>
                        <span
                            class="relative z-[1] w-4 shrink-0 self-stretch border-l border-[var(--border)] sm:w-6 md:w-12 lg:border-l-0"
                            aria-hidden="true"
                        >
                            <div
                                class="default-border-text-color pointer-events-none absolute top-0 bottom-0 left-[-0.5px] w-[10px] -translate-x-1/2"
                            >
                                ...
                                >
                                    <div
                                        class="w-px flex-[4.369975210805412] bg-current"
                                    />
                                    <div
                                        class="w-px flex-[3.3009514819369428] bg-current"
                                    />
                                </div>
                            </div>
                        </span>
                ...
                <main v-else-if="isPost" class="flex min-h-0 flex-1 flex-col">
                    <section
                        class="outer-section-node-offset relative z-[1] flex shrink-0 !min-h-fit min-h-[450px] min-w-0"
                    >
                        <div
                            class="pointer-events-none absolute z-[110] size-1.5 rotate-45 border border-offgray-100 bg-[var(--node-bg)] dark:border-offgray-900 dark:bg-[hsl(219,92%,2%)] [top:calc(-1*var(--node-vertical-offset))] [left:var(--node-horizontal-offset)]"
                            aria-hidden="true"
                        ...
                        >
                            ...
                            >
                                ...
                                >
                                    <div
                                        class="w-px flex-[1.06775] bg-current"
                                    />
                                    <div
                                        class="w-px flex-[4.56125] bg-current"
                                    />
                                </div>
                            </div>
                        </span>
                        ...
                        >
                            ...
                            >
                                ...
                                >
                                    <div
                                        class="w-px flex-[2.8108] bg-current"
                                    />
                                    <div
                                        class="w-px flex-[4.99621] bg-current"
                                    />
                                </div>
                            </div>
                        </span>
                        ...
                        >
                            ...
                            />
                            <div
                                class="isolate relative size-full overflow-clip px-4 py-4 lg:px-12 lg:py-10"
                            >
                                <header
                                    class="flex w-full flex-col justify-center gap-6"
                                >
                                    <h1
                                        class="zed-detail-hero-title font-plex-serif scroll-mt-24 text-accent-blue dark:text-blue-300"
                                    >
                                        {{ postHeroTitle }}
                                    </h1>
                                    <div
                                        v-if="
                                            postHeroDate || postHeroTags.length
                                        "
                                    ...
                                    >
                                        ...
                                        >
                                            <p
                                                v-if="postHeroDate"
                                                class="text-xs text-offgray-600 dark:text-offgray-500 tabular-nums"
                                            >
                                                {{ postHeroDate }}
                                            </p>
                                            <span
                        ...
                        >
                            ...
                            >
                                ...
                                >
                                    <div
                                        class="w-px flex-[3.88216] bg-current"
                                    />
                                    <div
                                        class="w-px flex-[1.86957] bg-current"
                                    />
                                    <div
                                        class="w-px flex-[1.07832] bg-current"
                                    />
                                    <div
                                        class="w-px flex-[1.44673] bg-current"
                                    />
                                    <div
                                        class="w-px flex-[4.04746] bg-current"
                                    />
                                </div>
                            </div>
                        </span>
                        ...
                        >
                            ...
                            >
                                ...
                                >
                                    <div
                                        class="w-px flex-[3.37969] bg-current"
                                    />
                                    <div
                                        class="w-px flex-[3.98229] bg-current"
                                    />
                                    <div
                                        class="w-px flex-[4.16155] bg-current"
                                    />
                                    <div
                                        class="w-px flex-[2.14013] bg-current"
                                    />
                                </div>
                            </div>
                        </span>
                    ...
                    <section
                        class="outer-section-node-offset relative z-[1] flex min-h-[calc(100vh-250px)] min-w-0 flex-1 items-stretch border-t default-border-color"
                    >
                        <div
                            class="pointer-events-none absolute z-[110] size-1.5 rotate-45 border border-offgray-100 bg-[var(--node-bg)] dark:border-offgray-900 dark:bg-[hsl(219,92%,2%)] [top:calc(-1*var(--node-vertical-offset))] [left:var(--node-horizontal-offset)]"
                            aria-hidden="true"
                        ...
                        >
                            <div
                                class="default-border-text-color pointer-events-none absolute top-0 right-[-0.5px] bottom-0 w-[10px] translate-x-1/2"
                            >
                                <div
                                    class="absolute top-0 bottom-0 left-1/2 flex w-px -translate-x-1/2 flex-col"
                                >
                                    <div
                                        class="w-px flex-[4.03169] bg-current"
                                    />
                                    <div
                                        class="w-px flex-[4.55797] bg-current"
                                    />
                                    <div
                                        class="w-px flex-[3.70754] bg-current"
                                    />
                                    <div
                                        class="w-px flex-[1.7575] bg-current"
                                    />
                                    <div
                                        class="w-px flex-[3.88886] bg-current"
                                    />
                                </div>
                            </div>
                        </span>
                        ...
                        >
                            ...
                            >
                                ...
                                >
                                    <div
                                        class="w-px flex-[2.80838] bg-current"
                                    />
                                    <div
                                        class="w-px flex-[4.39461] bg-current"
                                    />
                                </div>
                            </div>
                        </span>
                        <div
                            class="relative z-[2] container-max-w flex max-md:min-w-0 min-h-0 flex-1 flex-col [--node-horizontal-offset:-3.5px]"
                        >
                            <div
                                class="pointer-events-none absolute z-[110] size-1.5 rotate-45 border border-offgray-100 bg-[var(--node-bg)] dark:border-offgray-900 dark:bg-[hsl(219,92%,2%)] [top:calc(-1*var(--node-vertical-offset))] [left:var(--node-horizontal-offset)] hidden lg:block"
                                aria-hidden="true"
                            ...
                            />
                            <div
                                class="isolate relative flex min-h-0 min-w-0 flex-1 flex-col justify-between gap-6 pl-3 pr-0 pt-4 pb-6 lg:flex lg:flex-row-reverse lg:items-start lg:gap-8 lg:gap-x-6 lg:pl-7 lg:pr-0 lg:pt-9 lg:pb-12 xl:gap-x-8"
                            >
                                <aside
                                ...
                                <div
                                    class="zed-article min-w-0 flex-1 lg:max-w-[min(var(--blog-content-width),100%)] VPDoc"
                                >
                                    <Content
                                        class="vp-doc"
                                        :class="[
                        ...
                        >
                            ...
                            >
                                ...
                                >
                                    <div
                                        class="w-px flex-[2.45501] bg-current"
                                    />
                                    <div
                                        class="w-px flex-[3.12177] bg-current"
                                    />
                                    <div
                                        class="w-px flex-[4.95768] bg-current"
                                    />
                                    <div
                                        class="w-px flex-[4.67424] bg-current"
                                    />
                                </div>
                            </div>
                        </span>
                        ...
                        >
                            ...
                            >
                                ...
                                >
                                    <div
                                        class="w-px flex-[3.24898] bg-current"
                                    />
                                    <div
                                        class="w-px flex-[3.4364] bg-current"
                                    />
                                    <div
                                        class="w-px flex-[4.80649] bg-current"
                                    />
                                </div>
                            </div>
                        </span>
                ...
                <main v-else class="flex flex-1 flex-col">
                    <section
                        class="outer-section-node-offset relative z-[1] flex min-h-[calc(100vh-57px)] min-w-0 border-t default-border-color py-10"
                    >
                        <span
                            class="relative z-[1] w-4 shrink-0 border-r border-[var(--border)] sm:w-6 md:w-12 lg:border-r-0"
                            aria-hidden="true"
                        ...
                        />
                        <div
                            class="zed-article container-max-w relative flex-1 px-4 lg:px-12 VPDoc"
                        >
                            <Content
                                class="vp-doc"
                                :class="[
        ...
        >
            ...
            >
                <div
                    class="font-plex-serif mb-3 text-2xl text-offgray-1000 dark:text-white"
                >
                    Menu
                </div>
                <a
                ...
                >
                    <FileText
                        class="size-[18px] shrink-0 text-offgray-500 dark:text-offgray-400"
                        stroke-width="2"
                        aria-hidden="true"
                    />
