...
<Badge type="warning">#算法/二叉树</Badge> <Badge type="warning">#算法/树</Badge>  <Badge type="tip">#算法/数据结构</Badge> <Badge type="tip">#2023/04/18</Badge>
...
![image.png|704](images/9a9462b0ae355f83607ec904d5df7553.png)

![image.png|691](images/05dd6048d8688e6a58ef6e8518485942.png)
...
![image.png|679](images/c75df744c97e5b34e295bbd2eacaf267.png)
...
![image.png](images/1b4993fbc44e95f344a1f3bd840babd4.png)

![image.png](images/86921645374e40f809a54fb522b7f5f1.png)
...
![image.png](images/26939446c9517db965095fb586848172.png)

## 平衡二叉查找树

二叉树中`任意一个节点的左右子树`的`高度相差不能大于 1`

![image.png](images/42e64492eba910a231f01894b3811630.png)

![image.png](images/2130d9f3b6d123735105cd614780218d.png)

## 二叉树的存储方式

### 链式存储 - 对象

![image.png|606](images/1f57396c6c7d0ec0908c8fd1d70696d0.png)

### 顺序存储 - 数组

`完全二叉树`用`数组`来存储是最省内存的方式

![image.png|565](images/e29fe4038c62a7dc643d94fc78940983.png)

非完全二叉树则会浪费空间，如下图：

![image.png|390](images/cf10cd1cdb8a374b53403b941b9b9e96.png)
...
![image.png](images/8963bb8f3b7b3a6a1fa71319e058bde3.png)
...
![image.png](images/ef6da5215ad8e2ff32b2ea49faaa631f.png)

![image.png|510](images/ac3f6d93656aceb38de5dfe7f1e81277.png)
...
---
# 阅读原文
- https://liguwe.github.io/post/de7d537f-1a3d-572c-baaa-a98b3e5ff9d5