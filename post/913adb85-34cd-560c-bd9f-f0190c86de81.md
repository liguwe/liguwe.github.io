...
![image.png|480](images/ea5f6229f7163afc408a23aef0728791.png)

时间复杂度由多项式 `T(n)` 中最高阶的项来决定。这是因为在趋于无穷大时，最高阶的项将发挥主导作用，其他项的影响都可以被忽略。即 **“系数无法撼动阶数”** ， 当趋于无穷大时，这些常数变得无足轻重，如下图：

![image.png|315](images/dfa3c541c8fde0817d043413d5a96f39.png)
...
![image.png|585](images/4e79ed2e30c215179f648fdd5000f363.png)
...
> [!info]
> ![image.png|600](images/88cb8b3a7d878706742e70be0d6f2b23.png)
...
![image.png|465](images/ac00b7799791dc9505590961d2bbb4bb.png)
...
![image.png|480](images/3ff8899588e1ffa4f4b94073eabdef94.png)
...
![image.png|600](images/27ec8375a419fee15f4b37ce2a8cc49f.png)

#### 7、阶乘阶：O(n!)

即 `「全排列」` 问题

![image.png|360](images/ae31393acb0b846e96cc6e127721d0d1.png)
...
![image.png|600](images/4c8a91efffc89dcd586e114161a7ea49.png)
...
![image.png|600](images/dfe9b1eb0d0a84c7053f69f794a367b6.png)
...
![image.png|525](images/f6b5154844af6165acfa600c31d34e64.png)

#### 4、指数阶：O(2^n)

常见与构造二叉树，且关注最终的 `节点个数`，即占用的空间。

![image.png|510](images/5147e79065e5fab121c166b6a62a25ac.png)

![image.png|810](images/4f6e32f2f25b2223ae034964af127da9.png)

#### 5、对数阶：O(log n)

![image.png|600](images/1061ba6d1caec553eef45ce34c47290b.png)
...
---
# 阅读原文
- https://liguwe.github.io/post/913adb85-34cd-560c-bd9f-f0190c86de81