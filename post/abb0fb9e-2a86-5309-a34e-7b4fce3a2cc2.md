...
![image.png](images/a23f834894698150b65d89b2e90a114b.png)
...
![image.png](images/dad56d30851776aaa0d0013efaa2657e.png)

最终打印打印结果如下：

![image.png](images/600012a76446416d4da522feda21dcef.png)
...
![image.png](images/5c5b642583e840f36397285fcc704362.png)
...
![image.png](images/59695e0cb1ba69822703c8331a1a8224.png)

但是，上面的代码，仅仅能够`手动执行` ，如下代码：

![image.png](images/260154b4dd68f7ad7ef19756b82e2c69.png)

如果 `fn` 为 `getter函数`呢？ 如下：

![image.png](images/ae6fe72e0144e4163551ed6d33499af7.png)
...
![image.png](images/a98e63f4c4852a00772f35adfd86ff82.png)
...
![image.png](images/a556151be49028b61aed343a8004bace.png)
...
下面是 `watch 函数`的代码
![image.png](images/da6db5c1eac462e6f73f3eb948cf957e.png)
...
![image.png](images/042e6bf78a9a8259189409afb4483f4f.png)

所以，会存在`过期的副作用函数`，`第三个参数`就是解决这种`竞态问题`的 ，以下是代码实现：

![image.png](images/8f96dc3b2b20d089d3a7ca4761a7bd1e.png)

> 注意上面代码的 **高亮部分**

下面是 **使用实例**：

![image.png](images/1b234eff805c2e7687b61b480cc60c25.png)

所以，最终的效果如下：

![image.png](images/28a7e28cb9716b9bb888b8f633cfb536.png)
...
<div class="liguwe-doc-footer" id="liguwe.site.blog-doc-footer">
            <div class="liguwe-doc-footer-edit-link">
                <p class="liguwe-doc-footer-p">
                    ...
                    <a href="https://www.yuque.com/liguwe/post/abb0fb9e-2a86-5309-a34e-7b4fce3a2cc2" target="_blank" class="liguwe-doc-footer-edit-link-a">
                ...
                <p class="liguwe-doc-footer-p">
                    ...
                    <a href="https://github.com/liguwe/liguwe.github.io/blob/master/post/abb0fb9e-2a86-5309-a34e-7b4fce3a2cc2.md" target="_blank" class="liguwe-doc-footer-edit-link-a">Edit this page on Github</a>
                </p>
            </div>
