...
![图片&文件](./files/Pastedimage20240915080005.png)
...
![图片&文件](./files/Pastedimage20240915081034.png)
...
![图片&文件](./files/Pastedimage20240915082052.png)
...
基于 [#有向加权图（邻接表实现）](/post/3bac70b5d80e5c84b684970c74f43eaa.html#有向加权图（邻接表实现）) 只需要添加以下两行代码即可
...
在 [#6.3. 有向加权图（邻接矩阵实现）](/post/3bac70b5d80e5c84b684970c74f43eaa.html#63-有向加权图（邻接矩阵实现）)中添加两行代码即可，如下：
