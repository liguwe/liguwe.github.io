...
基于 [#有向加权图（邻接表实现）](/post/f2e8ae348167525bb8fa48574695162c.html#有向加权图（邻接表实现）) 只需要添加以下两行代码即可
...
在 [#6.3. 有向加权图（邻接矩阵实现）](/post/f2e8ae348167525bb8fa48574695162c.html#63-有向加权图（邻接矩阵实现）)中添加两行代码即可，如下：
