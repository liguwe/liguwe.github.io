...
2、`undefined` 和 `null` 既可以作为**值**，也可以作为**类型**，取决于在哪里使用它们。更多参考 [#^d3044f](/post/0927f4aa31095575b47649057769f4da.html#^d3044f)
...
### （五）Unknown
1、使用 `any` 有很多弊端 ，参考如上： [#^4fa065](/post/0927f4aa31095575b47649057769f4da.html#^4fa065) ，这就引出了 `unknown`
