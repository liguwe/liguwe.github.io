...
>  - [41. React 的 Diff 算法](/post/k91Z5ikz.html)
>  - [14. Vue3 的 Diff 算法复杂的分析](/post/4rSdWbIF.html)
...
看个例子，由 `vnode1` 变成 `vnode2` ，如果按照 [12. Vue3 渲染器的原理和实现](/post/YwoYvgaX.html) 中的简易实现，即 `先卸载所有，再挂载所有`，那么：我们需要 `8 次 DOM 操作`
