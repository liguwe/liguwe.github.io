...
2、`undefined` 和 `null` 既可以作为**值**，也可以作为**类型**，取决于在哪里使用它们。更多参考 [undefined](post/8c7c513d03805f34a37ca4ecbbd79c15.md)
...
var multi:number[][] = [undefined](post/8c7c513d03805f34a37ca4ecbbd79c15.md);
```
...
### （五）Unknown
1、使用 `any` 有很多弊端 ，参考如上： [undefined](post/8c7c513d03805f34a37ca4ecbbd79c15.md) ，这就引出了 `unknown`
