...
2、`undefined` 和 `null` 既可以作为**值**，也可以作为**类型**，取决于在哪里使用它们。更多参考 [#^d3044f](/post/8c7c513d03805f34a37ca4ecbbd79c15.html#^d3044f)
...
var multi:number[][] = [1,2,3], [23,24,25](/post/8c7c513d03805f34a37ca4ecbbd79c15.html#1,2,3],-[23,24,25);
```
...
### （五）Unknown
1、使用 `any` 有很多弊端 ，参考如上： [#^4fa065](/post/8c7c513d03805f34a37ca4ecbbd79c15.html#^4fa065) ，这就引出了 `unknown`
