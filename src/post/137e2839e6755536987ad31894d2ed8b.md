...
[https://www.figma.com/file/hT9k2YbVvV1UIITtUmbJ0C/2023.05.LOG?type=whiteboard&node-id=147-181&t=sZSmw8G9XgtflSer-4](https://www.figma.com/file/hT9k2YbVvV1UIITtUmbJ0C/2023.05.LOG?type=whiteboard&node-id=147-181&t=sZSmw8G9XgtflSer-4)
...
如果使用 `vnode` 描述 真实场景中的 `文本节点` 与 `注释节点` ？答案是：使用 `Symbol()` ，如下代码：
