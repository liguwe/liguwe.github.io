...
前文  [1. Vue3 的渲染器原理](post/c80f89e649b95ceeb658a4c8f72146c0.md) 实现了对单个 `vdom` 的渲染，比如对下面 `vdom` 的渲染：
...
关于调度器微任务队列的实现，更多参考 [3. Vue3 的响应式的系统设计原理](post/c80f89e649b95ceeb658a4c8f72146c0.md)
