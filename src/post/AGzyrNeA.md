...
- 使用 `console.dir` 递归打印出所有对象，比如打印出一个 DOM 元素，以前都不能直接看里面的元素
...
## 24. 发现没有，清理函数都是通过 return 返回的

- 比如 vue watch 的 `cleanup`
- 比如 React useEffect 的返回值
- 又比如平时写的函数等等

## 25. git merge 与 git rebase 有什么区别
...
## 48. 接上题`mainFields: ["browser", "module", "main"]`, 关于这几个主字段的选择，有什么区别吗？
