...
只要在上文 [#二叉树中寻找值为 val1 或 val2 的节点](/post/N6kAyZMd.html#二叉树中寻找值为-val1-或-val2-的节点) 中修改**后序位置**的部分代码即可实现
...
> 同 [#二叉树中两个节点的最近公共祖先](/post/N6kAyZMd.html#二叉树中两个节点的最近公共祖先) ，但两个节点不一定在二叉树中 
