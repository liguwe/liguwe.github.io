...
> 详见 [4. 使用特定任务模型](/post/qil1mvloi0.html)

## 利用嵌入向量的分类任务

> 详见 [5. 利用嵌入向量的分类任务](/post/lyacf8nvh1.html)  
> 另需要补充的初高中知识点： [5. 余弦相似度如何衡量高维向量的接近度](/post/azykx680b6.html)

## 使用生成模型进行文本分类

>  详见 [6 使用生成模型进行文本分类](/post/6y519xlkyb.html)
