...
1. **找到链表的中点**：
    ...
    - 当快指针到达链表末尾时，慢指针会到达链表的**中点位置**
        - 因此，**慢指针可以用来分割链表**。
2. **反转链表的后半部分**：可参考 [12. 算法/3. 刷题篇/1. LeetCode 精华 75 题/31.  反转链表|31.  反转链表](/post/WqAz7Qh1.html#12-算法/3-刷题篇/1-LeetCode-精华-75-题/31--反转链表|31--反转链表)
...
> 完全反转链表可参考 [12. 算法/3. 刷题篇/1. LeetCode 精华 75 题/31.  反转链表|31.  反转链表](/post/WqAz7Qh1.html#12-算法/3-刷题篇/1-LeetCode-精华-75-题/31--反转链表|31--反转链表)
### 复杂度分析
